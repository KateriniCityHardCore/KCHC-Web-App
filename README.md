...
* **Υποστήριξη PWA (Progressive Web App)**: Δυνατότητα εγκατάστασης της εφαρμογής σε Desktop και Κινητά για γρήγορη πρόσβαση.
...
* **vite-plugin-pwa**: Για τη δημιουργία του Progressive Web App.

## 📲 Εγκατάσταση ως Εφαρμογή (PWA)

Η εφαρμογή υποστηρίζει την τεχνολογία PWA. Αυτό σημαίνει ότι μπορείτε:
- Στο **Desktop** (Chrome, Edge): Να κάνετε κλικ στο εικονίδιο εγκατάστασης στη γραμμή διευθύνσεων.
- Στο **Κινητό** (iOS, Android): Να επιλέξετε "Προσθήκη στην Αρχική Οθόνη" (Add to Home Screen) από το μενού του browser.

## ⚙️ Εγκατάσταση και Εκτέλεση (για developers)
